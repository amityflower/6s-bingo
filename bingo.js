...
const median_tile = Math.ceil(tiles / 2);
...
const tile_state = new Array(tiles).fill(false);
...
function update_num_bingos() {
    const num_bingos = get_num_bingos();
    const element = document.getElementById('num_bingos_text');
    let num_bingos_text = '';
